            ...
            <div className=' flex flex-col  gap-y-2 justify-between flex-1'>
                ...
                <div className='flex justify-between'>
                    ...
                    <button onClick={() => console.log()} className='flex gap-x-2 items-center cursor-pointer group '>
                        <Share2 size={14} className="stroke-current group-hover:stroke-green-400 md:w-4 md:h-4" />
                        <span className='text-[14px] group-hover:text-green-400 md:text-[15px]'>Share</span>
                    </button>
                </div>
            </div>
        </div>
